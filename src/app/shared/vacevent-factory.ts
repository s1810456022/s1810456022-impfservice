...
export class VaceventFactory {
 static empty(): Vacevent {
   return new Vacevent(null,new Date(),new DatePipe(''),new DatePipe(''), 0, 0, [{id: 0, firstName: '', lastName: '', admin: false, gender: '', dateOfBirth: new Date(), svnr: 0, phoneNumber: 0, street: '', houseNumber: '', postalCode: 0, city: '', vacStatus: false, email: '', password: '', vacevent_id: 0}]);
 }
